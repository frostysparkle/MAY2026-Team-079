 ...
 * transforms). Purely presentational: `aria-hidden` and non-interactive.
 * Reused across the landing, splash and auth screens as the app's "brand moment".
 */
  ...
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(circle at 1px 1px, rgba(20,20,31,0.12) 1px, transparent 0)',
